::  graft-anchor — NockApp with full Vesl settlement tier
::
::  Extends the graft-sigil pattern with settlement: verify data
::  integrity AND transition notes from %pending to %settled.
::  Replay protection included.  Drop anchor.
::
...
++  inner
  ...
  ++  poke
    ...
    ?~  act
      ~>  %slog.[3 'graft-anchor: invalid cause']
      [~ state]
    ?-  -.u.act
