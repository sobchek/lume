::  tests/example-lume-test.hoon: Example using lume-test library
::
::  Demonstrates all assertion patterns from lume-test.
::  Compile with: hoonc protocol/tests/example-lume-test.hoon $NOCK_HOME/hoon/
...
=/  pending-note  [id=1 vessel=1 root=root state=[%pending ~]]
::
::  Valid case succeeds
