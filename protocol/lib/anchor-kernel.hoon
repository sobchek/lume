::  anchor-kernel.hoon: heavy tier — full settlement, no STARK
::
...
::  (71K lines, 135s compile) making the JAR 18MB — same as kraken.
::  The Rust hull handles transaction building natively.  Anchor stays
...
::
::  Compiled: hoonc --new protocol/lib/anchor-kernel.hoon hoon/
  ...
  ++  poke
    ...
    ?-  -.u.act
      ...
      ?:  (~(has in settled.state) id.note.args)
        ~>  %slog.[3 'anchor: note already settled (replay rejected)']
        [~ state]
