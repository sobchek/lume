::  vigil-kernel.hoon: mid tier — commitment + verification
::
...
::
::  Keep vigil: verify data integrity without settling.
::
::  Poke causes:
...
::
::  Compiled: hoonc --new protocol/lib/vigil-kernel.hoon hoon/
