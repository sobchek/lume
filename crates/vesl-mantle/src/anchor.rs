...
impl Anchor {
    ...
    ///
    /// Verification happens locally via Vigil. The kernel poke
    ...
    pub async fn settle(
        ...
        anyhow::ensure!(
            self.vigil.check_manifest(manifest, root),
