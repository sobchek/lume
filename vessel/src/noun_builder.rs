...
//! hash encoding. This module adds Lume-specific structure builders matching
//! `protocol/lib/lume-entrypoint.hoon:+$settlement-payload`.
...
///
/// Constructs `[%register vessel=@ root=@]`.
