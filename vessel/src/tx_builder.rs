//! Raw transaction builder for Lume settlement on Nockchain.
//!
...
pub struct SettlementTxParams {
    ...
    /// The Lume settlement data to embed.
...
/// Build a signed settlement transaction with Lume NoteData.
///
...
pub async fn build_settlement_tx(
    ...
    // 4. Encode Lume settlement as NoteData entries
...
// ---------------------------------------------------------------------------
// NoteData encoding for Lume settlement
// ---------------------------------------------------------------------------

/// Encode Lume SettlementData as NoteData entries (JAM'd nouns).
...
mod tests {
    ...
    fn jam_seeds_manual_matches_seeds_to_noun() {
        ...
        // Build a Seed with Lume NoteData — same structure as settlement path
        let settlement = SettlementData {
            version: 1,
            vessel_id: 7,
